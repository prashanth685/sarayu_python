...
class AuthWindow(QWidget):
    ...
    def create_login_tab(self):
        ...
        logo_path = "logo.png" if os.path.exists("logo.png") else "icons/placeholder.png"
        pixmap = QPixmap(logo_path)
        login_logo_label.setPixmap(pixmap.scaled(100, 100, Qt.KeepAspectRatio))
        login_logo_label.setAlignment(Qt.AlignCenter)
        layout.addWidget(login_logo_label)

        email_label = QLabel('Email')
        email_label.setStyleSheet("font-size: 16px; color: #333;")
        ...
        password_label.setStyleSheet("font-size: 16px; color: #333;")
        ...
        forgot_link = QLabel('<a href="#" style="color: #007bff; text-decoration: none;">Forgot Password?</a>')
        ...
        license_link = QLabel('<a href="#" style="color: #007bff; text-decoration: none;">Learn user license agreement</a>')
        license_link.setOpenExternalLinks(True)
        layout.addRow(license_link)
    ...
    def create_signup_tab(self):
        ...
        confirm_password_label.setStyleSheet("font-size: 16px; color: #333;")
